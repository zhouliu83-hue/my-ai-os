...
description: |
  ...
  触发方式：/zz-xhs-title、/小红书标题、「帮我起个小红书标题」「小红书标题公式」
  Xiaohongshu title formula tool. Pick the right formula from 75 proven templates.
  Trigger: /zz-xhs-title, "xiaohongshu title", "RED title formula"
---

# zz-xhs-title：小红书标题公式工具
...
| 触发条件 | 推荐 |
|---|---|
| 标题选好，想优化开头 | 「标题定了，接下来优化开头。用 `/zz-hook`。」 |
| 标题选好，想做完整内容诊断 | 「想看内容整体有没有问题？用 `/zz-content`。」 |
