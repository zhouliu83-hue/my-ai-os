...
description: |
  ...
  触发方式：/zz-learning、/zz-learn、/交互式学习、「带我学一个课题」「继续下一篇」「根据我的反馈写下一篇」
  Interactive learning workflow. Builds an adaptive sequence of learning articles based on user feedback.
  Trigger: /zz-learning, /zz-learn, "teach me a topic", "continue the next lesson"
---
...
| 执行力诊断 | `/zz-action` |
| 慢就是快 | `/zz-slowisfast` |
| 好问题生成 / Agent 可解性判断 | `/zz-good-question` |
